...
var _ver_major = Module['_ver_major'] = makeInvalidEarlyAccess('_ver_major');
var _ver_minor = Module['_ver_minor'] = makeInvalidEarlyAccess('_ver_minor');
var _ver_patch = Module['_ver_patch'] = makeInvalidEarlyAccess('_ver_patch');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['ver_major'] != 'undefined', 'missing Wasm export: ver_major');
  assert(typeof wasmExports['ver_minor'] != 'undefined', 'missing Wasm export: ver_minor');
  assert(typeof wasmExports['ver_patch'] != 'undefined', 'missing Wasm export: ver_patch');
